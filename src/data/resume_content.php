...
$resumeData = [
    "pageTitle" => "Resume",
    "contactInfo" => [
        ["icon" => "fas fa-envelope", "text" => "<a href=\"mailto:me@aaronperkel.com\">me[at]aaronperkel.com</a>"],
        ...
        ["icon" => "fas fa-globe", "text" => "<a href=\"http://aaronperkel.com\">aaronperkel.com</a>"],
    ...
    "experience" => [
        ...
        [
            ...
            "details" => [
                ...
                "Respond to tickets via phone & email, resolving 95% within SLA",
                "Maintained internal documentation and automated onboarding workflows"
            ]
        ]
    ],
    "education" => [
    ...
    "skillsAndInterests" => [
        "categories" => [
            [
                "<strong>Languages:</strong> Python, Java, C++, C#, C",
    ...
    "downloadLink" => "public/aaron-perkel-resume.pdf"
];
